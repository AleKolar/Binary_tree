...
class BinaryTree:
    ...
    def __str__(self):
        if self.left_child == None:
            self.left_child = self.value
        if self.right_child == None:
            self.right_child = self.value
        return f'Левое = {self.left_child}:{self.value}, Правое = {self.right_child}:{self.value}'
